package app.rbzeta.edcimplementationtracker.listener;
...
//        Log.i(mTag, "onScrolled-------dy:" + dy);
        ...
        //int totalItemCount = (currentPage == 0) ? adapter.getItemCount(): adapter.getItemCount() - 1;
...
//                            Log.i(mTag, "!!!!currentpage:" + currentPage);
                ...
                totalItemCount = (adapter.getItemViewType(totalItemCount -1) == EDCRecyclerAdapter.VIEW_TYPE_LOADING)
